...
/*   Updated: 2019/04/12 17:12:39 by cquillet         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	return (create3(t, 0., 0., 0.));
}

t_vector3		one3(t_type3 t)
{
	return (create3(t, 1., 1., 1.));
}
...
{
	return (scalar3(v, 1.f / module3(v)));
}

t_vector3		*normalize3(t_vector3 *v)
{
	*v = scalar3(*v, 1.f / module3(*v));
	return (v);
}
...
{
	return (add3(scalar3(a, 1.f - t), scalar3(b, t)));
}
